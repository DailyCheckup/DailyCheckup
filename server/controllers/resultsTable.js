...
let allRows = [
  ...
  { questionid: 74,
    ...
    e_count: 0,
    n_count: 0,
    question: '74. An 82-year-old white male has a cardiopulmonary arrest while mowing his lawn and his heartrhythm is restored after 8 minutes of CPR by a neighbor. He is now your patient in the coronarycare unit. He is on a ventilator and has severe hypoxic encephalopathy. Echocardiography showsan ejection fraction of 12% as a result of the massive anterior myocardial infarction he sustained.Your neurology consultant confirms that the patient will never again be able to meaningfullycommunicate, and will be ventilator-dependent.Prior to this, the patient had been living independently and had no health problems. He has noliving relatives, and his attorney confirms that he has no written advance directives. Theneighbor, who is a close friend, tells you that on several occasions recently he and the patienthad discussed such a scenario, and that the patient had said that if he had little chance of ameaningful recovery he would not want to remain on life support.In consultation with the hospital ethics committee, which one of the following would be mostappropriate in this case?',
    answer: 'C',
    reason: '4The most common form of advance directive is a patient\'92s conversations with relatives and friends, andthese carry the same ethical and legal weight as written directives. Neither the hospital attorney nor thepatient\'92s personal attorney, in the absence of a previous discussion with the patient, has the ethical or legalauthority to make the decision. Since the patient has previously expressed his wishes, it is unnecessary tohave the court appoint a surrogate decision maker. Care should be transferred to another physician onlyif the original physician has a philosophical or religious objection to carrying out the patient\'92s wishes. Ref: Halter JB, Ouslander JG, Tinetti ME, et al (eds): Hazzard\'92s Geriatric Medicine and Gerontology, ed 6. McGraw-HillMedical, 2009, pp 388-389. ',
    genre: 'PEDS',
    a_option: 'A) Transfer care of the patient to another physician',
    b_option: 'B) Ask a court to appoint a guardian to make medical decisions',
    c_option: 'C) Withdraw life support',
    d_option: 'D) Defer the decision regarding life support to the hospital attorney',
    e_option: 'E) Ask the patient\'92s attorney to decide whether to terminate life support' },
  { questionid: 142,
    num_of_people_correct: 4,
    num_of_people_incorrect: 0,
    date: '2016-07-13',
  ...
  { questionid: 213,
    ...
    e_count: 0,
    n_count: 1,
    question: '213. A 52-year-old male presents for a routine physical examination. His laboratory results reveal anAST (SGOT) level of 124 U/L (N 10\'9640) and an ALT (SGPT) level of 36 U/L (N 10\'9655). His_-glutamyl transpeptidase (GGTP) level is also elevated.The most likely cause of this abnormality is',
    answer: 'D',
    reason: '13In a study of 256 asymptomatic Swedish patients with mildly elevated liver transaminase levels, alcoholwas found to be the cause in 10% of cases. An accurate history is important for making the diagnosis. Abiopsy alone cannot differentiate alcoholic liver disease from nonalcoholic fatty liver disease. AnAST/ALT ratio >2 supports a diagnosis of alcoholic liver disease. Elevated \u0004-glutamyl transpeptidase(GGTP) is also associated with alcohol abuse, especially in a patient with an AST/ALT ratio >2. Ref: Oh RC, Hustead TR: Causes and evaluation of mildly elevated liver transaminase levels. Am Fam Physician2011;84(9):1003-1008. ',
    genre: 'GYN',
    a_option: 'A) hepatitis C',
    b_option: 'B) hemochromatosis',
    c_option: 'C) nonalcoholic fatty liver disease',
    d_option: 'D) alcoholic liver disease',
    e_option: 'E) statin-induced liver disease' },
  { questionid: 180,
    num_of_people_correct: 1,
    num_of_people_incorrect: 3,
    date: '2016-07-13',
    ...
    e_count: 0,
    n_count: 1,
    question: '180. Which one of the following is a preferred first-line agent for managing hypertension in patientswith stable coronary artery disease?',
    answer: 'C',
    reason: '80American Heart Association guidelines recommend treating hypertension in patients with stable heartfailure with ACE inhibitors and/or \u0003-blockers. Other agents, such as thiazide diuretics or calcium channelblockers, can be added if needed to achieve blood pressure goals (SOR B). \u0003-Blockers with intrinsicsympathomimetic activity should be avoided, as they increase myocardial oxygen demand.While thiazide diuretics are often a first choice for uncomplicated hypertension, this is not the case forpatients with coronary artery disease. Long-acting calcium channel blockers may be used in patients whodo not tolerate \u0003-blockers, but short-acting calcium channel blockers should be avoided because theyincrease mortality. ACE inhibitors are recommended as antihypertensive agents in patients already on\u0003-blocker therapy (especially following myocardial infarction), in diabetics, and in patients with leftventricular dysfunction. Although angiotensin receptor blockers have indications similar to those of ACEinhibitors, the American Heart Association recommends using them only in patients who do not tolerateACE inhibitors. Long-acting nitrates are used for their anti-anginal properties and have no role in themanagement of hypertension. Ref: Pflieger M, Winslow BT, Mills K, Dauber IM: Medical management of stable coronary artery disease. Am Fam Physician2011;83(7):819-826. 2) Fihn SD, Gardin JM, Abrams J, et al: 2012 ACCF/AHA/ACP/AATS/PCNA/SCAI/STS guidelinefor the diagnosis and management of patients with stable ischemic heart disease: A report of the American College ofCardiology Foundation/American Heart Association task force on practice guidelines, and the American College ofPhysicians, American Association for Thoracic Surgery, Preventive Cardiovascular Nurses Association, Society forCardiovascular Angiography and Interventions, and Society of Thoracic Surgeons. Circulation 2012;126(25):e354-e471. ',
    genre: 'OB',
    a_option: 'A) A thiazide diuretic',
    b_option: 'B) An angiotensin receptor blocker',
    c_option: 'C) A _-blocker',
    d_option: 'D) A long-acting calcium channel blocker',
    e_option: 'E) A long-acting nitrate' },
  { questionid: 221,
    num_of_people_correct: 2,
    num_of_people_incorrect: 2,
    date: '2016-07-13',
    ...
    e_count: 0,
    n_count: 1,
    question: '221. A 54-year-old male sees you for a 6-month follow-up visit for hypertension. He feels well, butdespite the fact that he takes his medications faithfully, his blood pressure averages 150/90 mmHg. He has had an intensive workup for hypertension in the recent past, with normal repeatlaboratory results, including a CBC, serum creatinine, an electrolyte panel, and a urinalysis. Hismedications include chlorthalidone, 12.5 mg daily; carvedilol (Coreg), 25 mg twice daily;amlodipine (Norvasc), 10 mg daily; and lisinopril (Prinivil, Zestril), 40 mg daily. He has beenintolerant to clonidine (Catapres) in the past.Which one of the following medication changes would be most reasonable?',
    answer: 'B',
    reason: '21Spironolactone is now recommended for treating resistant hypertension, even when hyperaldosteronismis not present. A longer-acting diuretic such as chlorthalidone is also recommended for treatinghypertension, particularly in resistant cases with normal renal function. There is no benefit to switchingfrom an ACE inhibitor to an ARB. Nitrates have some effect on blood pressure but are recommended onlyfor patients with coronary artery disease. Ref: Nishizaka MK, Zaman MA, Calhoun DA: Efficacy of low-dose spironolactone in subjects with resistant hypertension. AmJ Hypertens 2003;16(11 Pt 1):925-930. 2) Myat A, Redwood SR, Qureshi AC, et al: Resistant hypertension. BMJ2012;345:e7473. 3) Adams M, Bellone JM, Wright BM, Rutecki GW: Evaluation and pharmacologic approach to patientswith resistant hypertension. Postgrad Med 2012;124(1):74-82. ',
    genre: 'PEDS',
    a_option: 'A) Adding isosorbide mononitrate (Imdur)',
    b_option: 'B) Adding spironolactone (Aldactone)',
    c_option: 'C) Substituting furosemide (Lasix) for chlorthalidone',
    d_option: 'D) Substituting losartan (Cozaar) for lisinopril',
    e_option: 'null' },
  { questionid: 49,
    num_of_people_correct: 1,
    num_of_people_incorrect: 0,
    ...
    e_count: 0,
    n_count: 0,
    question: '49. A 75-year-old male comes to your office for a routine follow-up visit for hypertension. He isasymptomatic but your evaluation reveals atrial fibrillation. An echocardiogram is normal exceptfor mild left ventricular hypertrophy.Which one of the following would be most appropriate at this point?',
    answer: 'D',
    reason: '9This patient\'92s age and his history of hypertension give him a CHADS2 score of 2, which implies that thepatient is at a higher risk of thromboembolism and should be anticoagulated with warfarin and not aspirin.The patient should be fully anticoagulated for a minimum of 3 weeks prior to any attempt at cardioversion. Ref: Gutierrez C, Blanchard DG: Atrial fibrillation: Diagnosis and treatment. Am Fam Physician 2011;83(1):61-68. ',
    genre: 'OB',
    a_option: 'A) No anticoagulation',
    b_option: 'B) Medical cardioversion',
    c_option: 'C) Anticoagulation with aspirin',
    d_option: 'D) Anticoagulation with warfarin',
    e_option: 'null' },
  { questionid: 155,
    num_of_people_correct: 1,
    num_of_people_incorrect: 0,
    ...
    e_count: 1,
    n_count: 0,
    question: '155. You are counseling a 45-year-old obese male regarding weight loss. The patient has elevatedtriglycerides, low HDL-cholesterol, and stage 1 hypertension. He does not currently takemedications and would like to avoid taking medications in the future. The patient has heard goodthings about low-carbohydrate diets and asks your opinion.A low-carbohydrate diet in a patient such as this is most likely to result in',
    answer: 'E',
    reason: '55Emerging data on low-carbohydrate diets is mostly encouraging, in that these diets do not seem to causethe expected increases in blood pressure, LDL-cholesterol levels, or triglyceride levels that the medicalcommunity had first assumed. Although low-carbohydrate diets have been shown to result in clinicallymeaningful weight loss, reduced-calorie diets appear to result in similar weight loss regardless of whichmacronutrients they emphasize. This patient has symptoms of metabolic syndrome and has a higher riskof glucose intolerance or diabetes mellitus. Low-carbohydrate diets have been shown to reduce insulinresistance at least as well as, if not better than, traditional diet plans. Ref: Nordmann AJ, Nordmann A, Briel M, et al: Effects of low-carbohydrate vs low-fat diets on weight loss and cardiovascularrisk factors: A meta-analysis of randomized controlled trials. Arch Intern Med 2006;166(3):285-293. 2) Barker LR, BurtonJR, Zieve PD (eds): Principles of Ambulatory Medicine, ed 7. Lippincott Williams & Wilkins, 2007, p 1429. 3) GardnerCD, Kiazand A, Alhassan S, et al: Comparison of the Atkins, Zone, Ornish, and LEARN diets for change in weight andrelated risk factors among overweight premenopausal women: The A TO Z Weight Loss Study: A randomized trial. JAMA2007;297(9):969-977. 4) Sacks FM, Bray GA, Carey VJ, et al: Comparison of weight-loss diets with differentcompositions of fat, protein, and carbohydrates. N Engl J Med 2009;360(9):859-873. 5) Longo DL, Fauci AS, Kasper DL,et al (eds): Harrison\'92s Principles of Internal Medicine, ed 18. McGraw-Hill, 2012, p 633. ',
    genre: 'Endocrine',
    a_option: 'A) increased LDL-cholesterol',
    b_option: 'B) increased triglycerides',
    c_option: 'C) increased blood pressure',
    d_option: 'D) development of metabolic syndrome',
    e_option: 'E) better short-term weight loss than with a low-fat diet' },
  { questionid: 226,
    num_of_people_correct: 1,
    num_of_people_incorrect: 0,
    date: '2016-07-14',
    ...
    e_count: 0,
    n_count: 0,
    question: '226. A heroin overdose is most likely to cause acute',
    answer: 'D',
    reason: '26Until recently, the number of heroin overdoses had been in decline for the past few decades. Althoughheroin still only accounts for about 1% of drug overdoses, it has become more common in the past fewyears. Overdose is manifested by CNS depression and hypoventilation. Clinical clues include pupillarymiosis and a decreasing respiratory rate in the presence of a semi-wakeful state. In addition tohypoventilation, a multifactorial acute lung injury occurs within 2\'964 hours of the overdose and is associatedwith hypoxemia and a hypersensitivity reaction, resulting in noncardiogenic pulmonary edema. Findingsinclude hypoxia, crackles on lung auscultation, and pink, frothy sputum. Treatment must includerespiratory support with intubation, mechanical ventilation, and oxygen, as well as opiate reversal withnaloxone, which may require repeat doses or intravenous infusion.Arrhythmias and myocardial ischemia/infarction do not occur as direct pharmacologic effects of heroin,although they may occur as a consequence of the pulmonary toxicity or the presence of other drugs takenintentionally or otherwise (i.e., heroin cut with other agents). Acute renal injury, hepatic injury, andthromboembolic events are also not a direct result of the pharmacologic effects of heroin. Ref: Shannon MW, Borron SW, Burns M: Haddad and Winchester\'92s Clinical Management of Poisoning and Drug Overdose,ed 4. Saunders Elsevier, 2007, pp 644-645. 2) Li W, Gunja N: Illicit drug overdose: Prevalence and acute management.Aust Fam Physician 2013;42(7):481-485. ',
    genre: 'GI',
    a_option: 'A) renal failure',
    b_option: 'B) hepatic necrosis',
    c_option: 'C) myocardial infarction',
    d_option: 'D) pulmonary edema',
    e_option: 'E) pelvic thrombophlebitis' },
  { questionid: 120,
    num_of_people_correct: 0,
    num_of_people_incorrect: 1,
    date: '2016-07-14',
    ...
    e_count: 0,
    n_count: 0,
    question: '120. An 87-year-old female is brought to the emergency department after losing consciousness at thedinner table. Her history indicates recent unintentional weight loss. Further evaluation ultimatelyreveals a large mass at the head of the pancreas and extensive metastasis to numerous organs,including the brain. Her life expectancy is estimated to be 2\'963 weeks. The patient chooses toreceive hospice care but becomes very depressed.Which one of the following would be best for improving her depression?',
    answer: 'B',
    reason: '20There is good evidence that psychostimulants reduce symptoms of depression within days, makingmethylphenidate a good choice for this patient (SOR B). Electroconvulsive therapy is contraindicated dueto her brain lesions. Mirtazapine, fluoxetine, and nortriptyline all take at least 3\'964 weeks to have anyantidepressant effects, and would not be appropriate given the patient\'92s life expectancy (SOR B). Ref: Widera EW, Block JD: Managing grief and depression at the end of life. Am Fam Physician 2012;86(3):259-264. ',
    genre: 'Orthopedic',
    a_option: 'A) Electroconvulsive therapy',
    b_option: 'B) Methylphenidate (Ritalin)',
    c_option: 'C) Mirtazapine (Remeron)',
    d_option: 'D) Fluoxetine (Prozac)',
    e_option: 'E) Nortriptyline (Pamelor)' },
  { questionid: 205,
    num_of_people_correct: 0,
    num_of_people_incorrect: 1,
    date: '2016-07-14',
    ...
    e_count: 0,
    n_count: 0,
    question: '205. In a patient without allergies who is admitted to the hospital for hip joint replacement, which oneof the following is the recommended prophylactic antibiotic?',
    answer: 'C',
    reason: '05Cefazolin is the recommended prophylactic antibiotic for most patients undergoing orthopedic proceduressuch as total joint replacement, unless the patient has a \u0003-lactam allergy (SOR A). Ref: Salkind AR, Rao KC: Antibiotic prophylaxis to prevent surgical site infections. Am Fam Physician 2011;83(5):585-590.2) Bratzler DW, Dellinger EP, Olsen KM, et al: Clinical practice guidelines for antimicrobial prophylaxis in surgery. AmJ Health Syst Pharm 2013;70(3):195-283. ',
    genre: 'GI',
    a_option: 'A) Ampicillin',
    b_option: 'B) Ampicillin/sulbactam (Unasyn)',
    c_option: 'C) Cefazolin',
    d_option: 'D) Clindamycin (Cleocin)',
    e_option: 'E) Vancomycin (Vancocin)' }
];
